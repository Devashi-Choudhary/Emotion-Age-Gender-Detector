...
if len(detected) > 0:
    for i, d in enumerate(detected):
        ...
        cv2.putText(frame, emotion_text, (x1,y2) ,cv2.FONT_HERSHEY_SIMPLEX, 0.8 ,(255, 255, 255),  lineType=cv2.LINE_AA)
    ...
    for i, d in enumerate(detected):
        ...
        cv2.putText(frame, label, (d.left(), d.top()), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 255, 255), 1, lineType=cv2.LINE_AA)
